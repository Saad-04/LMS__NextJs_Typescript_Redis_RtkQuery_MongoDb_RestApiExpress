...
import { useGetAdminAllCoursesQuery, useGetUsersAllCoursesQuery } from '../../../../redux/features/courses/courseApi';
  ...
  return (
    <div className={!isDashboard ? 'mt-[120px]' : 'mt-[0px]'}>
      {isLoading ? (
        ...
        <Box bgcolor={'dark:bg-[#111C43]'} m={isDashboard ? '0' : '40px'}>
          <Box
