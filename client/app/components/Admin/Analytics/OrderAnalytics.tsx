      ...
      {isLoading ? (
        ...
        <div className={isDashboard ? 'h-[30vh]' : 'h-screen'}>
          <div className={isDashboard ? 'mt-[0px] pl-[40px] mb-2' : 'mt-[50px]'}>
            <h1 className={`${styles.title} ${isDashboard && '!text-[20px]'} 800px:pl-20  px-5 !text-start`}>
              Orders Analytics
            </h1>
            {!isDashboard && <p className={`${styles.label}800px:pl-20  px-5`}>Last 12 months analytics data </p>}
          </div>
