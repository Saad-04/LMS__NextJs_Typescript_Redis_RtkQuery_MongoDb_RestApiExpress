...
const Reviews = (props: Props) => {
  return (
    <div className="w-[90%] 800px:w-[85%] pt-10 m-auto">
      <div className="w-full 800px:flex justify-center  items-center">
        <div className="800px:w-[80%] w-full">
          ...
          <p className={styles.label}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque unde voluptatum dignissimos, nulla
            perferendis dolorem voluptate nemo possimus magni deleniti natus accusamus officiis quasi nihil commodi,
