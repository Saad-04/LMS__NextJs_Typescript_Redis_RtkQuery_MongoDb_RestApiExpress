...
const ProfileOptions: FC<Props> = ({ user, active, avatar, setActive, logOutHandler }) => {
  return (
    <div className="w-full">
      <div
        ...
        />
        <h5 className="pl-2 800px:block hidden font-Poppins dark:text-white text-black">{user.name}</h5>
      </div>
      <div
        className={`w-full flex items-center px-3 py-4 cursor-pointer ${
