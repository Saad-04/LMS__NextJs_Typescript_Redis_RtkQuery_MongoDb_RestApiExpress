  ...
  return (
    <footer>
      ...
      <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center flex-wrap sm:flex-col">
          <div className="space-y-3">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/privacy-policy" className="text-base text-black dark:text-white dark:hover:text-white">
                  Privacy Policy
                </Link>
              </li>
              <li>
        ...
        <br />
        <p className="text-center text-black dark:text-white">Copyright © 2023 ELearning | All Rights Reserved</p>
      </div>
      <br />
    </footer>
  );
